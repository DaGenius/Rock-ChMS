        ...
        protected void ShowEditValue( int valueId )
        {
            ...
            if ( valueModel != null )
            {
                ...
                foreach (var attribute in gridAttributes)
                {
                    ...
                    //fieldType = new Rock.Web.Cache();

                    //Control editControl = new FieldType.Field.EditControl();
                    
                    // = attribute.Name;


                    //phAttrControl.Controls.Add( editControl);
                    i++;
                }
